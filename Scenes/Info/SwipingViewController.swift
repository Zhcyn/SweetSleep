...
class SwipingViewController: UIViewController {
    ...
    //MARK: - Properties
    var pages: [Page] = [
            Page(imageName: "Base-1", text: "I'm good in bed", isButtonActive: false, color: .yellow),
            Page(imageName: "Base-2", text: "Be A Morning Person", isButtonActive: false, color: .orange),
            Page(imageName: "Base-3", text: "Close my eyes", isButtonActive: false, color: .red),
            Page(imageName: "Base-4", text: "Dream Dream Dream", isButtonActive: true, color: .green)
    ]
